...
6. **Deployment / Data Story**  
   PowerPoint-presentatie met inzichten.
...
## Gebruik:
1. Open `train_eda.ipynb` om data understanding en preparation uit te voeren.
2. Gebruik de .... dataset voor modellering.
3. Open de model notebooks om voorspellingen en evaluaties uit te voeren.
4. Bekijk de PowerPoint voor de Data Story.
